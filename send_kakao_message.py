...
# 카카오톡 API 설정
KAKAO_API_KEY = 'cf04e839ef69c883ff5623c69b51ddda'
KAKAO_UPLOAD_URL = 'https://kapi.kakao.com/v1/api/talk/memo/upload/multi'
...
# 로컬 이미지 파일 경로 리스트
image_files = [
    "C:\rd-project\image1.png", "C:\rd-project\image2.png", "C:\rd-project\image3.png", "C:\rd-project\image4.png", "C:\rd-project\image5.png", "C:\rd-project\image6.png", "C:\rd-project\image7.png", "C:\rd-project\image8.png", "C:\rd-project\image9.png", "C:\rd-project\image10.png", "C:\rd-project\image11.png"
]
...
def upload_image(image_path):
    with open(image_path, 'rb') as image:
        files = {'file': image}
        response = requests.post(KAKAO_UPLOAD_URL, headers=headers, files=files)
...
def send_text_message(text):
    data = {
        'template_object': json.dumps({
            ...
            'text': text,
            'link': {
                'web_url': 'http://localhost:8000',  # 로컬 웹사이트 URL로 수정
                'mobile_web_url': 'http://localhost:8000'  # 로컬 웹사이트 URL로 수정
            },
            'button_title': '확인'
        })
    }
    ...
    if response.status_code == 200:
        print(f"텍스트 메시지 전송 성공: {text}")
    else:
        print(f"텍스트 메시지 전송 실패: {response.text}")
